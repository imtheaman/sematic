...
const Contributions: NextPage = () => {
    ...
    return (
      <div className="flex space-x-3 bg-white h-48 w-full p-4 text-gray-700 justify-items-center shadow-sm overflow-scroll rounded-lg mt-8">
        ...
        <div className="flex flex-col space-y-2 h-full justify-center px-4">
          <button
            ...
            className={
              contributionYear === currentYear ? "btn-selected" : "btn"
            }
          >
            {currentYear}
          </button>
